...
const PopUpModal = ({ isOpen, onClose, children, className = "" }) => {
  useEffect(() => {
    if (!isOpen) return;
  ...
  return (
    ...
    >
      <div className="relative bg-pink-200  opacity-90 backdrop-blur-sm rounded-full w-[858px] h-[420px] flex items-center justify-center px-6 shadow-lg">
        {/* 왼쪽 아이콘 */}
        <img
          src={toggleLeft}
          alt="left"
