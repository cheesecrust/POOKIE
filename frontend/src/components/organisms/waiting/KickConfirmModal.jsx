...
const KickConfirmModal = ({ isOpen, targetUser, onConfirm, onCancel }) => {
	return (
		<BasicModal isOpen={isOpen} onClose={onCancel} className="w-[360px] h-[220px] bg-pink-200 rounded-lg">
			<div className="flex flex-col items-center justify-center h-full space-y-6 text-center font-[pixel]">
				...
				<p className="text-sm text-black">
					<span className="font-semibold text-lg text-black">{targetUser?.userNickname}</span>
					님을 강퇴시키겠습니까?
				</p>
