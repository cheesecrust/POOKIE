...
async def upload_images(
    ...
    def pair_score(i, j):
        ...
        if not pair_gate[key]["ok"]:
            return 0.0  # 사전검사 실패 → 바로 낮은 점수 반환
